...
# coq_makefile Atoms.v BDefinitions.v Completeness.v CutCases.v CutElimination.v Eqset.v InvCopy.v InvPlus.v InvTensor.v MSet.v MultisetLL.v Multisets.v SequentCalculi.v Soundness.v StrongInduction.v StructuralRules.v StructuralRulesTriSystem.v Syntax.v TriSystem.v myTactics.v 
#
...
VFILES:=LL/Atoms.v\
  LL/Focusing/BDefinitions.v\
  LL/Focusing/Completeness.v\
  LL/MetaTheory/CutCases.v\
  LL/MetaTheory/CutElimination.v\
  LL/Eqset.v\
  LL/Focusing/InvCopy.v\
  LL/Focusing/InvPlus.v\
  LL/Focusing/InvTensor.v\
  LL/Focusing/MSet.v\
  LL/MultisetLL.v\
  LL/Multisets.v\
  LL/SequentCalculi.v\
  LL/Focusing/Soundness.v\
  LL/MetaTheory/StrongInduction.v\
  LL/MetaTheory/StructuralRules.v\
  LL/Focusing/StructuralRulesTriSystem.v\
  LL/Syntax.v\
  LL/Focusing/TriSystem.v\
  LL/myTactics.v
...
.merlin:
	...
	@echo "B /Users/carlosolarte/tmp/LL-master" >> .merlin
	@echo "S /Users/carlosolarte/tmp/LL-master" >> .merlin
